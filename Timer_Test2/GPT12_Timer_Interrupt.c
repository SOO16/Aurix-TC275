...
void initGpt12Timer(void)
{
    ...
    volatile Ifx_SRC_SRCR *src_T3 = IfxGpt12_T3_getSrc(&MODULE_GPT120);                /* Get the interrupt address    */
    IfxSrc_init(src_T3, ISR_PROVIDER_GPT12_TIMER, ISR_PRIORITY_GPT12_TIMER_T3);           /* Initialize service request   */
    IfxSrc_enable(src_T3);                                                             /* Enable GPT12 interrupt       */
